...
<?php
     ...
     if (isset($_SERVER['HTTP_REFERER']) == true) {
          if (limpa_pro($_SESSION['wrknompro']) != limpa_pro($_SERVER['HTTP_REFERER'])) {
               ...
               $ret = gravar_log(6,"Entrada na página de consulta de usuáruos do sistema Pallas.40 - Figueira Costa");  
          }
     }
?>
...
function carrega_usu() {
     ...
     foreach ($reg as $lin) {
         ...
         $txt .= '<td class="lit-d text-center"><a href="man-usuario.php?ope=3&cod=' . $lin['idsenha'] . '" title="Efetua exclusão do registro informado na linha"><i class="large material-icons">delete_forever</i></a></td>';
         ...
         if ($lin['usutipo'] == 0) {$txt .= '<td class="text-center">' . "Usuário" . "</td>";}
         if ($lin['usutipo'] == 1) {$txt .= '<td class="text-center">' . "Administrador" . "</td>";}
