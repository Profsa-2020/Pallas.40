...
<head>
	...
	<link rel="icon" href="https://www.figueiracosta.com.br/wp-content/uploads/2017/09/cropped-favicon-32x32.png" sizes="32x32" />
     ...
     <title>Controle Gerencial de Apuração e Análise de Vendas - Login</title>
</head>
     ...
     if (isset($_POST['entrar']))  {
          ...
          if (trim($ema) == "") {
               ...
               if ($ret > 1) {
                    ...
                    } else if ($reg['usutipo'] < 0) { // 0-visitante, 1-cliente, 2-colaborador, 3-chefe, 4-supervisor, 5-diretor, 6-presidente
...
<body class="login">
     <h1 class="cab-0">Login Sistema Figueira Costa - Análise de Vendas à Varejo - Profsa Informática</h1>
     <div class="entrada">
               ...
               <form name="frmLogin" action="" method="POST">
                    ...
                    <div class="row">
                         <a href="http://www.figueiracosta.com.br/">
                              <img class="ima-1" src="img/logo-1.png" alt="Logotipo da empresa Figuera Costa"
                                   title="Acesso ao site principal da empresa Figueria Costa" />
                         </a>
                    </div>
                    <br /><br />
                    <div class="row">
